...
/* harmony import */ var _film_film_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./film/film.component */ "./src/app/film/film.component.ts");
...
var routes = [
    ...
    { path: 'film/:id', component: _film_film_component__WEBPACK_IMPORTED_MODULE_3__["FilmComponent"] },
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            imports: [
                angular_2_local_storage__WEBPACK_IMPORTED_MODULE_3__["LocalStorageModule"].withConfig({
                    prefix: 'films',
...
var FilmComponent = /** @class */ (function () {
    function FilmComponent(route, filmsService) {
        this.route = route;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this;
                        return [4 /*yield*/, this.filmsService.getById(this.route.snapshot.paramMap.get('id'))];
                    case 1:
                        _a.film = _b.sent();
                        return [2 /*return*/];
                }
    ...
    FilmComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_1__["ActivatedRoute"], _films_service__WEBPACK_IMPORTED_MODULE_2__["FilmsService"]])
    ], FilmComponent);
...
var FilmsService = /** @class */ (function () {
    function FilmsService(http) {
        this.apiKey = '6b7e837e';
        this.http = http;
    }
    FilmsService.prototype.search = function (query) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this
                .http
                .get("http://www.omdbapi.com/?apikey=" + _this.apiKey + "&s=" + query)
    ...
    FilmsService.prototype.getById = function (id) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this
                .http
                .get("http://www.omdbapi.com/?apikey=" + _this.apiKey + "&i=" + id)
                .subscribe(function (response) {
                if (response.Response === 'True') {
                    resolve(response);
                }
...
var ListComponent = /** @class */ (function () {
    function ListComponent(localStorage) {
        this.localStorage = localStorage;
    }
    ListComponent.prototype.films = function () {
        var _this = this;
        return this.localStorage.keys().map(function (id) { return _this.localStorage.get(id); });
    };
    ListComponent.prototype.removeFromSaved = function (id) {
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _films_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../films.service */ "./src/app/films.service.ts");
...
var SearchComponent = /** @class */ (function () {
    function SearchComponent(filmsService, localStorage) {
        var _this = this;
        this.query = 'matrix';
        this.queryChanged = new rxjs__WEBPACK_IMPORTED_MODULE_3__["Subject"]();
        this.filmsService = filmsService;
        this.localStorage = localStorage;
        this.queryChanged
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["debounceTime"])(250))
            .subscribe(function (query) {
            _this.filmsService.search(query).then(function (films) {
                _this.films = films;
            });
        });
    }
    ...
    SearchComponent.prototype.onSearchChange = function (query) {
        this.queryChanged.next(query);
    };
    SearchComponent.prototype.addToSaved = function (id) {
        var film = this.films.find(function (f) { return f.imdbID === id; });
        this.localStorage.set(id, film);
    };
    SearchComponent.prototype.removeFromSaved = function (id) {
        this.localStorage.remove(id);
    };
    SearchComponent.prototype.isSaved = function (id) {
    ...
    SearchComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_films_service__WEBPACK_IMPORTED_MODULE_1__["FilmsService"], angular_2_local_storage__WEBPACK_IMPORTED_MODULE_2__["LocalStorageService"]])
    ], SearchComponent);
...
module.exports = __webpack_require__(/*! /Users/artem/node/films/src/main.ts */"./src/main.ts");
